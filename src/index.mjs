...
const PRODUCT = {
  "repo": "vwo-experiment-risk-ledger",
  "vendor": "VWO",
  "title": "experiment risk ledger",
  "domain": "Experimentation",
  "audience": "Growth leaders, product marketers, experimentation teams, and revenue strategists",
  "problem": "Experiment results become hard to trust when variants, holdouts, segments, and launch decisions are not governed together.",
  "workflow": "The product maps each experiment to guardrails, decision owners, lift evidence, rollout risk, and buyer-safe narrative.",
  "business": "Leaders can see which tests deserve rollout, rollback, more instrumentation, or a stronger evidence packet.",
  "technical": "Synthetic experiment lanes are evaluated by a deterministic CLI and rendered into a static board brief.",
  "integration": "VWO experiments, variants, holdouts, conversion events, guardrails, and campaign decisions.",
  "keywords": [
    "VWO",
